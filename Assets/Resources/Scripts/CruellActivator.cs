...
public class CruellActivator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameObject.GetComponent<Renderer>().materials = new Material[] { whiteMaterial };
        isDefaultState = true;
    }
    ...
    private IEnumerator changeMaterial(bool isActive)
    {
        ...
        if (isDefaultState) meshRenderer.material = redMaterial;
        else meshRenderer.material = whiteMaterial;
